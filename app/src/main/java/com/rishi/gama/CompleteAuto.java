...
public class CompleteAuto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Retrieve the price from the intent
        Intent intentFromSelectAuto = getIntent();
        if (intentFromSelectAuto.hasExtra("price")) {
            price = intentFromSelectAuto.getStringExtra("price");
            // Now, you have the 'price' variable containing the price from the intent.
        }
        ...
        timeSlotSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                ...
                Toast.makeText(CompleteAuto.this, "Selected Time Slot: " + selectedTimeSlot, Toast.LENGTH_SHORT).show();
            }
        ...
        bookButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (name.isEmpty() || mobileNumber.isEmpty() || selectedDate.isEmpty() || selectedTimeSlot.isEmpty()) {
                    Toast.makeText(CompleteAuto.this, "Please fill in all the required fields.", Toast.LENGTH_SHORT).show();
                } else {
                    // All required fields are filled, proceed to the checkout page
                    // Create an Intent to start the CheckoutActivity
                    Intent intentToCheckout = new Intent(CompleteAuto.this, CheckoutActivity.class);
